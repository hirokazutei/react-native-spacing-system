...
> Warning, you are currently looking at the v1 documentation. For v2 documentation, please go over [here](https://github.com/hirokazutei/react-native-spacing-system/blob/develop/README.md).
