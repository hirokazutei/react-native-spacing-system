...
function insetFactory(spacing) {
    const Inset = (props) => {
        const { layout, children, _debug, _debugOptions } = props, keyedPaddings = __rest(props, ["layout", "children", "_debug", "_debugOptions"]);
        ...
        return React.createElement(View, {
            style: Object.assign(Object.assign({}, layoutStyle), isDebugMode
                ? Object.assign(Object.assign({}, styles.debug), { borderStyle: "solid", borderColor: (_debugOptions && _debugOptions.color) ||
