...
const mapPaddingsToStyle = (paddings) => {
    ...
    if (paddings.all) {
        ...
        return {
            default: Object.assign({ paddingHorizontal: paddings.horizontal }, (paddingTop ? { paddingTop } : {}), (paddingBottom ? { paddingBottom } : {})),
        ...
        return {
            ...
            debug: Object.assign({}, (paddingTop ? { borderTopWidth: paddingTop } : {}), (paddingRight ? { borderRightWidth: paddingRight } : {}), (paddingBottom ? { borderBottomWidth: paddingBottom } : {}), (paddingLeft ? { borderLeftWidth: paddingLeft } : {}))
        };
    }
};
export const obtainInsetPaddingStyle = ({ paddings, debugOptions }) => {
    ...
    return StyleSheet.create({
        ...
        debug: Object.assign({ borderStyle: "solid" }, styles.debug, { borderColor: DEFAULT_DEBUG_COLORS.inset || (debugOptions && debugOptions.color) })
    });
};
