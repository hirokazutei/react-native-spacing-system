...
const mapPaddingsToStyle = (paddings) => {
    ...
    if (paddings.all) {
        ...
        return {
            ...
            debug: Object.assign(Object.assign({ borderRightWidth: paddingHorizontal, borderLeftWidth: paddingHorizontal }, (paddingTop ? { borderToptWidth: paddingTop } : {})), (paddingBottom ? { borderBottomWidth: paddingBottom } : {}))
        };
        // Top & Right & Bottom & Left
    }
    else {
